...
class AvatarAudioSource(AudioSource):
    ...
    def __init__( self, session):
        ...
        """
        super(AvatarAudioSource, self).__init__()
    ...
    def __enter__(self):
        self.audio_service.setClientPreferences(self.module_name, AvatarAudioSource.RATE, 3, 0)
...
if __name__ == '__main__':
    ...
    with AvatarAudioSource(session) as mic:
        print "test"