...
class Face:
    def __init__(self):
        ...
        base_path = base_path[:base_path.find('gaze_service')]
        predictor_path = "gaze_service/gaze/models/shape_predictor_68_face_landmarks.dat"
        path_face_cass = 'gaze_service/gaze/models/haarcascade_frontalface_default.xml'
        path_eye_pair_cass = 'gaze_service/gaze/models/haarcascade_mcs_eyepair_big.xml'
        path_left_eye = 'gaze_service/gaze/models/haarcascade_mcs_lefteye.xml'
        path_right_eye = 'gaze_service/gaze/models/haarcascade_mcs_righteye.xml'
    ...
    def find_faces_openCV(self,frame):
        ...
        for (x,y,w,h) in faces:
            res.append([(long)(x), (long)(y), (long)(w), (long)(h)])
        return res
    ...
    def choose_best_eye_pair(self,eye_pair_rects, img):
        """ Determine between eyes / eyebrows / nostrils by comparing frequencies in image
        """

        return max(eye_pair_rects,key=lambda (x0, y0, w, h): ImageUtils.measure_blurriness_LoG(img[y0:y0 + h, x0:x0 + w]))
